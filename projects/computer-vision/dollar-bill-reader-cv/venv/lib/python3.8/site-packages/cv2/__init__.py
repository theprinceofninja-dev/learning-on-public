...
def bootst***():
    ...
    if sys.version_info[:2] < (3, 0):
        from . load_config_py2 import exec_file_w***per
    else:
        from . load_config_py3 import exec_file_w***per
    ...
    def load_first_config(fnames, required=True):
        for fname in fnames:
            ...
            exec_file_w***per(fpath, g_vars, l_vars)
            return True
        if required:
    ...
    sys.path = save_sys_path  # multiprocessing should start from bootst*** code (https://github.com/opencv/opencv/issues/18502)
