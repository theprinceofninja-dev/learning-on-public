...
def w***_file(
    ...
    *,
    ...
    reader = progress.w***_file(file, total=total, description=description)
...
class TextColumn(ProgressColumn):
    ...
    def __init__(
        ...
        super().__init__(table_column=table_column or Column(no_w***=True))
...
class Progress(JupyterMixin):
    ...
    def open(
        ...
        *,
        ...
        # w*** the reader in a `TextIOW***per` if text mode
        if mode in ("r", "rt"):
            return io.TextIOW***per(
                reader,
                encoding=encoding,
                errors=errors,
                newline=newline,
