...
class DependencyG***h(object):
    """
    Represents a dependency g***h between distributions.
    ...
    def add_distribution(self, distribution):
        """Add the *distribution* to the g***h.
    ...
    def to_dot(self, f, skip_disconnected=True):
        """Writes a DOT output for the g***h to the provided file *f*.
    ...
    def topological_sort(self):
        """
        Perform a topological sort of the g***h.
...
def make_g***h(dists, scheme='default'):
    """Makes a dependency g***h from the given distributions.

    :parameter dists: a list of distributions
    :type dists: list of :class:`distutils2.database.InstalledDistribution` and
                 :class:`distutils2.database.EggInfoDistribution` instances
    :rtype: a :class:`DependencyG***h` instance
    """
    scheme = get_scheme(scheme)
    g***h = DependencyG***h()
    provided = {}  # maps names to lists of (version, dist) tuples

    # first, build the g***h and find out what's provided
    for dist in dists:
        g***h.add_distribution(dist)
        ...
        for req in requires:
            ...
            if name in provided:
                for version, provider in provided[name]:
                    ...
                    if match:
                        g***h.add_edge(dist, provider, req)
                        matched = True
                        break
            if not matched:
                g***h.add_missing(dist, req)
    return g***h
...
def get_dependent_dists(dists, dist):
    ...
    todo = g***h.reverse_list[dist]  # list of nodes we should inspect

    while todo:
        d = todo.pop()
        dep.append(d)
        for succ in g***h.reverse_list[d]:
            if succ not in dep:
                todo.append(succ)
...
def get_required_dists(dists, dist):
    ...
    todo = g***h.adjacency_list[dist]  # list of nodes we should inspect
    seen = set(t[0] for t in todo)  # already added to todo

    while todo:
        d = todo.pop()[0]
        req.add(d)
        pred_list = g***h.adjacency_list[d]
