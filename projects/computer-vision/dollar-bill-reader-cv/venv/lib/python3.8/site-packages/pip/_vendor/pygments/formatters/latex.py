...
# * \PY@it, \PY@bf, etc. are unconditionally w***ped around the text
...
class LatexFormatter(Formatter):
    ...
    W***ping can be disabled using the `now***` option.
    ...
    `now***`
        If set to ``True``, don't w*** the tokens at all, not even inside a
