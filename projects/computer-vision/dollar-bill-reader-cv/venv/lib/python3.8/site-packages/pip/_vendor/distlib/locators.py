...
class Locator(object):
    ...
    def convert_url_to_download_info(self, url, project_name):
        ...
        has typically been sc***ed from an HTML page).
...
class Page(object):
    """
    This class represents a sc***ed HTML page.
    """
...
""", re.I | re.S | re.X)
    ...
    def links(self):
        ...
        downloads and which ones to queue for further sc***ing.
        """
...
class SimpleSc***ingLocator(Locator):
    """
    A locator which sc***es HTML pages to locate downloads for a distribution.
    ...
    def __init__(self, url, timeout=None, num_workers=10, **kwargs):
        """
        Initialise an instance.
        :param url: The root URL to use for sc***ing.
        ...
        """
        super(SimpleSc***ingLocator, self).__init__(**kwargs)
        self.base_url = ensure_slash(url)
    ...
    def _should_queue(self, link, referrer, rel):
        ...
        particular "rel" attribute should be queued for sc***ing.
        """
    ...
    def _fetch(self):
        ...
        links for download candidates and candidates for further sc***ing.
...
default_locator = AggregatingLocator(
    ...
    SimpleSc***ingLocator('https://pypi.org/simple/', timeout=3.0),
    scheme='legacy')
