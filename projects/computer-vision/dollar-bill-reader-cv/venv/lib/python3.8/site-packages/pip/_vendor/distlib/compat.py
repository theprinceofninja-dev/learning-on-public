...
if sys.version_info[0] < 3:  # pragma: no cover
    ...
    string_types = str,
    text_type = str
    from io import TextIOW***per as file_type
    import builtins
    import configparser
    ...
    try:
        ...
        def _recursive_repr(fillvalue='...'):
            ...
            def decorating_function(user_function):
                ...
                # Can't use functools.w***s() here because of bootst*** issues
                w***per.__module__ = getattr(user_function, '__module__')
                w***per.__doc__ = getattr(user_function, '__doc__')
                w***per.__name__ = getattr(user_function, '__name__')
                w***per.__annotations__ = getattr(user_function,
                                                  '__annotations__', {})
                return w***per
...
try:
    ...
    # The ConvertingXXX classes are w***pers around standard Python containers,
    # and they serve to convert any suitable values in the container. The
    # conversion converts base dicts, lists and tuples to their w***ped
    # equivalents, whereas strings which match a conversion format are converted
    # appropriately.
    #
    # Each w***per should have a configurator attribute holding the actual
    # configurator to use for conversion.

    class ConvertingDict(dict):
        """A converting dictionary w***per."""
