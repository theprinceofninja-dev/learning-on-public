...
from pip._internal.utils.misc import StreamW***per, ensure_dir, hash_file, partition
...
def get_console_script_specs(console: Dict[str, str]) -> List[str]:
    ...
    # Special case pip and setuptools to generate versioned w***pers
    #
...
def _install_wheel(  # noqa: C901, PLR0915 function is too long
    ...
    #   generated = files newly generated during the install (script w***pers)
    installed: Dict[RecordPath, RecordPath] = {}
    ...
    def is_entrypoint_w***per(file: "File") -> bool:
    ...
    script_scheme_files = filterfalse(is_entrypoint_w***per, script_scheme_files)
    ...
    if pycompile:
        with contextlib.redirect_stdout(
            StreamW***per.from_stream(sys.stdout)
        ) as stdout:
