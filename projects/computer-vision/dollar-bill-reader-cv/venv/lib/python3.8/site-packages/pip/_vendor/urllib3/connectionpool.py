    ...
    def urlopen(
        ...
        **response_kw
        ...
        try:
            ...
            # Import httplib's response into our own w***per object
...
class HTTPSConnectionPool(HTTPConnectionPool):
    ...
    is available and are fed into :meth:`urllib3.util.ssl_w***_socket` to upgrade
    ...
    def _prepare_conn(self, conn):
        """
        Prepare the ``connection`` for :meth:`urllib3.util.ssl_w***_socket`
