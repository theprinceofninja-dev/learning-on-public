...
class Text(JupyterMixin):
    ...
    Args:
        ...
        no_w*** (bool, optional): Disable text w***ping, or None for default. Defaults to None.
    ...
    def __rich_console__(
        ...
        lines = self.w***(
            ...
            no_w***=pick_bool(self.no_w***, options.no_w***, False),
        )
        all_lines = Text("\n").join(lines)
    ...
    def w***(
        ...
        *,
        ...
        Args:
            ...
            no_w*** (bool, optional): Disable w***ping, Defaults to False.

        Returns:
            Lines: Number of lines.
        """
        w***_justify = justify or self.justify or DEFAULT_JUSTIFY
        w***_overflow = overflow or self.overflow or DEFAULT_OVERFLOW

        no_w*** = pick_bool(no_w***, self.no_w***, False) or overflow == "ignore"
        ...
        for line in self.split(allow_blank=True):
            ...
            if no_w***:
                ...
                offsets = divide_line(str(line), width, fold=w***_overflow == "fold")
                new_lines = line.divide(offsets)
            for line in new_lines:
                line.rstrip_end(width)
            if w***_justify:
                new_lines.justify(
                    console, width, justify=w***_justify, overflow=w***_overflow
                )
            for line in new_lines:
                line.truncate(width, overflow=w***_overflow)
