...
# 2001-05-09 fl   added TransposedFont w***per class
...
class ImageFont:
    ...
    def getmask(self, text, mode="", *args, **kwargs):
        ...
        :param mode: Used by some g***hics drivers to indicate what mode the
...
##
# W***per for FreeType fonts.  Application code should use the
# <b>truetype</b> factory function to create font objects.


class FreeTypeFont:
    """FreeType font w***per (requires _imagingft service)"""
    ...
    def getlength(
        ...
        :param features: A list of OpenType font features to be used during text
                         ...
                         features, see
                         https://learn.microsoft.com/en-us/typog***hy/opentype/spec/featurelist
                         Requires libraqm.
...
class TransposedFont:
    """W***per for writing rotated or mirrored text"""

    def __init__(self, font, orientation=None):
        """
        W***per that creates a transposed font from any existing font
        object.
