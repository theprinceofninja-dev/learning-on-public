...
# PNG support code
#
# See "PNG (Portable Network G***hics) Specification, version 1.0;
...
class PngImageFile(ImageFile.ImageFile):
    format = "PNG"
    format_description = "Portable network g***hics"
...
class _idat:
    # w*** output from the encoder in IDAT chunks
...
class _fdat:
    # w*** encoder output in fdAT chunks
