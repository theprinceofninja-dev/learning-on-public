...
def updateNameTable(varfont, axisLimits):
    ...
    typog***hic subfamily name associated with the new default instance.
    ...
    NameID 16 Typog***hic Family name: None --> "Open Sans"
    NameID 17 Typog***hic Subfamily name: None --> "Condensed"

    References:
    https://docs.microsoft.com/en-us/typog***hy/opentype/spec/stat
    https://docs.microsoft.com/en-us/typog***hy/opentype/spec/name#name-ids
    """
...
def _sortAxisValues(axisValues):
    ...
    # https://docs.microsoft.com/en-us/typog***hy/opentype/spec/stat#axis-value-table-format-4
    results = []
    seenAxes = set()
...
def _updateNameRecords(varfont, axisValues):
    ...
    for platform in platforms:
        ...
        # If neither subFamilyName and typog***hic SubFamilyName exist,
...
def _updateNameTableStyleRecords(
    ...
    if typoSubFamilyName:
        ...
        # Remove previous Typog***hic Family and SubFamily names since they're
        # no longer required
        for nameID in (
