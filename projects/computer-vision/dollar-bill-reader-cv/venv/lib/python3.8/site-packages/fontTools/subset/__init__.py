...
--drop-tables[+|-]=<table>[,<table>...]
  ...
  and G***hite tables: 'Feat', 'Glat', 'Gloc', 'Silf', 'Sill'.
...
codes, see: http://www.microsoft.com/typog***hy/otspec/name.htm
...
class Options(object):
    ...
    _drop_tables_default += ["Feat", "Glat", "Gloc", "Silf", "Sill"]  # G***hite
        ...
        for tag in tableTags:
            ...
            if tag == "OS/2":
                ...
                if self.options.prune_codepage_ranges and font[tag].version >= 1:
                    ...
                    # https://learn.microsoft.com/en-us/typog***hy/opentype/spec/os2#version-1
