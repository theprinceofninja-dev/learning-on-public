...
class RuleDescriptor(SimpleDescriptor):
    ...
    def __init__(self, *, name=None, conditionSets=None, subs=None):
        ...
        -  Note: By default, rules are applied first, before other text
           ...
           `Required Variation Alternates OpenType feature <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/features_pt#-tag-rvrn>`_.
...
class AbstractAxisDescriptor(SimpleDescriptor):
    ...
    def __init__(
        ...
        *,
        ...
        specification <https://www.microsoft.com/typog***hy/otspec/fvar.htm#VAT>`__.
        ...
        See: `OTSpec STAT Axis Record <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/stat#axis-records>`_
        ...
        See: `OTSpec STAT Axis Value Tables <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/stat#axis-value-tables>`_
...
class AxisLabelDescriptor(SimpleDescriptor):
    ...
    See: `OTSpec STAT Axis value table, format 1, 2, 3 <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/stat#axis-value-table-format-1>`_
    ...
    def __init__(
        ...
        *,
        ...
        See: `OTSpec STAT Flags <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/stat#flags>`_
        """
...
class LocationLabelDescriptor(SimpleDescriptor):
    ...
    See: `OTSpec STAT Axis value table, format 4 <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/stat#axis-value-table-format-4>`_
        ...
        for ruleElement in self.root.findall(".rules/rule"):
            ...
            if externalConditions:
                ...
                self.log.info(
                    ...
                    "W***ped them in a new conditionset."
                )
...
class DesignSpaceDocument(LogMixin, AsDictMixin):
    ...
    **Note:** Python attribute names are usually camelCased, the
    ...
    def __init__(self, readerClass=None, writerClass=None):
        ...
        See: `OTSpec STAT Style Attributes Header <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/stat#style-attributes-header>`_
