...
def buildCoverage(glyphs, glyphMap):
    ...
    Coverage tables (as defined in the `OpenType spec <https://docs.microsoft.com/en-gb/typog***hy/opentype/spec/chapter2#coverage-table>`__)
...
def buildLookup(subtables, flags=0, markFilterSet=None):
    ...
    A Lookup (as defined in the `OpenType Spec <https://docs.microsoft.com/en-gb/typog***hy/opentype/spec/chapter2#lookupTbl>`__)
    w***s the individual rules in a layout operation (substitution or
