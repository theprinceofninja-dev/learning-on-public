...
In 2016, OpenType 1.8 introduced the `CFF2 <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/cff2>`_
...
class IndexCompiler(object):
    """Base class for writing CFF `INDEX data <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/cff2#5-index-data>`_
    to binary."""
...
class FDArrayIndexCompiler(IndexCompiler):
    ...
    `Font DICT INDEX <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/cff2#10-font-dict-index-font-dicts-and-fdselect>`_
    to binary."""
...
class GlobalSubrsCompiler(IndexCompiler):
    """Helper class for writing the `global subroutine INDEX <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/cff2#9-local-and-global-subr-indexes>`_
    to binary."""
...
class SubrsCompiler(GlobalSubrsCompiler):
    """Helper class for writing the `local subroutine INDEX <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/cff2#9-local-and-global-subr-indexes>`_
    to binary."""
...
class CharStringsCompiler(GlobalSubrsCompiler):
    """Helper class for writing the `CharStrings INDEX <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/cff2#9-local-and-global-subr-indexes>`_
    to binary."""
...
class GlobalSubrsIndex(Index):
    ...
    `Subroutine Operators <https://docs.microsoft.com/en-us/typog***hy/opentype/otspec180/cff2charstr#section4.4>`)
    """
...
class TopDict(BaseDict):
    ...
    as described `here <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/cff2#7-top-dict-data>`_,
