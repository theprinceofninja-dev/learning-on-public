...
def compact(font: TTFont, level: int) -> TTFont:
    ...
    #     https://docs.microsoft.com/en-us/typog***hy/opentype/spec/gpos#lookup-type-2-pair-adjustment-positioning-subtable
...
def _classDef_bytes(
    ...
    # https://docs.microsoft.com/en-us/typog***hy/opentype/spec/chapter2#class-definition-table-format-1
    format1_bytes = 6 + glyphCount * 2
    # https://docs.microsoft.com/en-us/typog***hy/opentype/spec/chapter2#class-definition-table-format-2
...
class Cluster:
    ...
    def cost(self):
        if self._cost is None:
            self._cost = (
                ...
                # From: https://docs.microsoft.com/en-us/typog***hy/opentype/spec/gpos#pair-adjustment-positioning-format-2-class-pair-adjustment
    ...
    def coverage_bytes(self):
        format1_bytes = (
            # From https://docs.microsoft.com/en-us/typog***hy/opentype/spec/chapter2#coverage-format-1
        ...
        for start, end in ranges:
            ...
            last = end
        format2_bytes = (
            # From https://docs.microsoft.com/en-us/typog***hy/opentype/spec/chapter2#coverage-format-2
