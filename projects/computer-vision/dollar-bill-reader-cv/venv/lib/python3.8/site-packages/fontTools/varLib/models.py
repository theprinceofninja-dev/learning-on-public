...
def normalizeValue(v, triple, ext***olate=False):
...
def normalizeLocation(location, axes, ext***olate=False, *, validate=False):
    ...
    for tag, triple in axes.items():
        ...
        out[tag] = normalizeValue(v, triple, ext***olate=ext***olate)
    return out


def supportScalar(location, support, ot=True, ext***olate=False, axisRanges=None):
    """Returns the scalar multiplier at location, for a master
    with support.  If ot is True, then a peak value of zero
    for support of an axis means "axis does not participate".  That
    is how OpenType Variation Font technology works.

    If ext***olate is True, axisRanges must be a dict that maps axis
    names to (axisMin, axisMax) tuples.
      ...
      0.75
      >>> supportScalar({'wght':3}, {'wght':(0,1,2)}, ext***olate=True, axisRanges={'wght':(0, 2)})
      -1.0
      >>> supportScalar({'wght':-1}, {'wght':(0,1,2)}, ext***olate=True, axisRanges={'wght':(0, 2)})
      -1.0
      >>> supportScalar({'wght':3}, {'wght':(0,2,2)}, ext***olate=True, axisRanges={'wght':(0, 2)})
      1.5
      >>> supportScalar({'wght':-1}, {'wght':(0,2,2)}, ext***olate=True, axisRanges={'wght':(0, 2)})
      -0.5
    """
    if ext***olate and axisRanges is None:
        raise TypeError("axisRanges must be passed when ext***olate is True")
    scalar = 1.0
...
class VariationModel(object):
    ...
    If the ext***olate argument is set to True, then values are ext***olated
    ...
    def __init__(
        self, locations, axisOrder=None, ext***olate=False, *, axisRanges=None
    ):
    ...
    def getScalars(self, loc):
        ...
        return [
            supportScalar(
                loc, support, ext***olate=self.ext***olate, axisRanges=self.axisRanges
            )
