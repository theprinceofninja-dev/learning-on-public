...
class table__c_m_a_p(DefaultTable.DefaultTable):
    ...
    This class represents the `cmap <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/cmap>`_
    ...
    See also https://learn.microsoft.com/en-us/typog***hy/opentype/spec/cmap
    """
