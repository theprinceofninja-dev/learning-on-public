...
https://docs.microsoft.com/en-us/typog***hy/opentype/spec/svg
...
class table_S_V_G_(DefaultTable.DefaultTable):
    """Scalable Vector G***hics table

    The ``SVG`` table contains representations for glyphs in the SVG
    image format.

    See also https://learn.microsoft.com/en-us/typog***hy/opentype/spec/stat
    """

    def decompile(self, data, ttFont):
        self.docList = []
        # Version 0 is the standardized version of the table; and current.
        # https://www.microsoft.com/typog***hy/otspec/svg.htm
