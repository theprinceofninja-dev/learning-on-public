...
class table__g_l_y_f(DefaultTable.DefaultTable):
    ...
    This class represents the `glyf <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/glyf>`_
    ...
    def _getPhantomPoints(self, glyphName, hMetrics, vMetrics=None):
        ...
        https://docs.microsoft.com/en-us/typog***hy/opentype/spec/tt_instructing_glyphs#phantoms
        """
...
class Glyph(object):
    ...
    def getCoordinates(self, glyfTable, *, round=noRound):
        ...
        section of the `glyf table specification <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/glyf#simple-glyph-description>`.
        """
