...
class table__s_b_i_x(DefaultTable.DefaultTable):
    """Standard Bitmap G***hics table

    The ``sbix`` table stores bitmap image data in standard g***hics formats
    ...
    See also https://learn.microsoft.com/en-us/typog***hy/opentype/spec/sbix
    """
