...
from reportlab.g***hics.shapes import Path
...
class ReportLabPen(BasePen):
    """A pen for drawing onto a ``reportlab.g***hics.shapes.Path`` object."""
...
if __name__ == "__main__":
    ...
    w, h = g.width, 1000
    from reportlab.g***hics import renderPM
    from reportlab.g***hics.shapes import Group, Drawing, scale

    # Everything is w***ped in a group to allow transformations.
    g = Group(pen.path)
    g.translate(0, 200)
    g.scale(0.3, 0.3)
