...
class NormalizedAxisTripleAndDistances(AxisTriple):
    ...
    def renormalizeValue(self, v, ext***olate=True):
        ...
        if default < 0:
            return -self.reverse_negate().renormalizeValue(-v, ext***olate=ext***olate)
...
def verticalMetricsKeptInSync(varfont):
    ...
    https://learn.microsoft.com/en-us/typog***hy/opentype/spec/mvar
