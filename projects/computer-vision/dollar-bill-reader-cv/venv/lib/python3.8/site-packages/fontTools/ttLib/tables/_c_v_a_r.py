...
# https://www.microsoft.com/typog***hy/otspec/cvar.htm
# https://www.microsoft.com/typog***hy/otspec/otvarcommonformats.htm
...
class table__c_v_a_r(DefaultTable.DefaultTable):
    ...
    See also https://learn.microsoft.com/en-us/typog***hy/opentype/spec/cvar
    """
