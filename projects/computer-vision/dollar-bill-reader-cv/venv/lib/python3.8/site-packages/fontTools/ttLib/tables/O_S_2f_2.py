...
OS2_format_0 = """
	...
	sTypoAscender:          h       # typog***hic ascender
	sTypoDescender:         h       # typog***hic descender
	sTypoLineGap:           h       # typog***hic line gap
...
class table_O_S_2f_2(DefaultTable.DefaultTable):
    ...
    See also https://learn.microsoft.com/en-us/typog***hy/opentype/spec/os2
    """
...
OS2_UNICODE_RANGES = (
    ...
    (
        ("CJK Unified Ideog***hs", (0x4E00, 0x9FFF)),
        ("CJK Radicals Supplement", (0x2E80, 0x2EFF)),
        ("Kangxi Radicals", (0x2F00, 0x2FDF)),
        ("Ideog***hic Description Characters", (0x2FF0, 0x2FFF)),
        ("CJK Unified Ideog***hs Extension A", (0x3400, 0x4DBF)),
        ("CJK Unified Ideog***hs Extension B", (0x20000, 0x2A6DF)),
        ("Kanbun", (0x3190, 0x319F)),
    ),
    (("Private Use Area (plane 0)", (0xE000, 0xF8FF)),),
    (
        ("CJK Strokes", (0x31C0, 0x31EF)),
        ("CJK Compatibility Ideog***hs", (0xF900, 0xFAFF)),
        ("CJK Compatibility Ideog***hs Supplement", (0x2F800, 0x2FA1F)),
    ),
