...
from Quartz.CoreG***hics import CGPathCreateMutable, CGPathMoveToPoint
from Quartz.CoreG***hics import CGPathAddLineToPoint, CGPathAddCurveToPoint
from Quartz.CoreG***hics import CGPathAddQuadCurveToPoint, CGPathCloseSubpath
