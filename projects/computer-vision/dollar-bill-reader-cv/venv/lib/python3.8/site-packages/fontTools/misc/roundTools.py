...
def otRound(value):
    ...
    The OpenType spec (in the section on `"normalization" of OpenType Font Variations <https://docs.microsoft.com/en-us/typog***hy/opentype/spec/otvaroverview#coordinate-scales-and-normalization>`_)
