...
class Data:
    ...
    This class w***s binary data loaded from a plist file when the
...
def totree(
    ...
    Args:
        ...
        use_builtin_types (bool): If true, byte strings will be
            encoded in Base-64 and w***ped in a ``data`` tag; if
...
def fromtree(
    ...
    Args:
        ...
        use_builtin_types: If True, binary data is deserialized to
            bytes strings. If False, it is w***ped in :py:class:`Data`
...
def load(
    ...
    # lxml returns the target object directly, while ElementTree w***s
