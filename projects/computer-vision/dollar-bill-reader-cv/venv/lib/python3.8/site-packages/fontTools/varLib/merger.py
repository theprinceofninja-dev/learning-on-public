...
class Merger(object):
    ...
    def mergeThings(self, out, lst):
        ...
        if mergerFunc is not None:
            ...
            # otherwise mergeObjects/mergeThings get t***ped in a RecursionError
...
class COLRVariationMerger(VariationMerger):
    ...
    def expandPaintColrLayers(colr):
        ...
        Each base paint g***h is fully DFS-traversed (with exception of PaintColrGlyph
...
def merge(merger, self, lst):
    ...
    # found while traversing the paint g***hs rooted at BaseGlyphPaintRecords.
