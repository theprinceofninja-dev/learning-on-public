...
static PyObject *w***_error;
static PyObject *w***_module;

/************************************ call ************************************/
static char doc_f2py_rout_w***_call[] = "\
Function signature:\n\
...
"Return objects:\n"
"  arr : array";
static PyObject *f2py_rout_w***_call(PyObject *capi_self,
                                     PyObject *capi_args) {
  ...
  if (!PyArg_ParseTuple(capi_args,"iiOiO|:w***.call",\
  ...
  capi_arr_tmp = ndarray_from_pyobj(type_num,elsize,dims,rank,intent|F2PY_INTENT_OUT,arr_capi,"w***.call failed");
...
static char doc_f2py_rout_w***_attrs[] = "\
Function signature:\n\
  arr = array_attrs(arr)\n\
Required arguments:\n"
...
"  itemsize : int\n"
;
static PyObject *f2py_rout_w***_attrs(PyObject *capi_self,
                                      PyObject *capi_args) {
  PyObject *arr_capi = Py_None;
  ...
  int i;
  memset(s,0,100);
  if (!PyArg_ParseTuple(capi_args,"O!|:w***.attrs",
...
static PyMethodDef f2py_module_methods[] = {
  ...
  {"call",f2py_rout_w***_call,METH_VARARGS,doc_f2py_rout_w***_call},
  {"array_attrs",f2py_rout_w***_attrs,METH_VARARGS,doc_f2py_rout_w***_attrs},
  {NULL,NULL}
};
...
PyMODINIT_FUNC PyInit_test_array_from_pyobj_ext(void) {
  PyObject *m,*d, *s;
  m = w***_module = PyModule_Create(&moduledef);
  Py_SET_TYPE(&PyFortran_Type, &PyType_Type);
  import_array();
  if (PyErr_Occurred())
    Py_FatalError("can't initialize module w*** (failed to import numpy)");
  d = PyModule_GetDict(m);
  s = PyUnicode_FromString("This module 'w***' is auto-generated with f2py (version:2_1330).\nFunctions:\n"
                           "  arr = call(type_num,dims,intent,obj)\n"
                           ".");
  PyDict_SetItemString(d, "__doc__", s);
  w***_error = PyErr_NewException ("w***.error", NULL, NULL);
  Py_DECREF(s);
...
#undef ADDCONST(
  ...
  if (PyErr_Occurred())
    Py_FatalError("can't initialize module w***");

#ifdef F2PY_REPORT_ATEXIT
  on_exit(f2py_report_on_exit,(void*)"array_from_pyobj.w***.call");
#endif
