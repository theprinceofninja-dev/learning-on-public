...
def _w***_header_guess_version(header):
    """
    Like `_w***_header`, but chooses an appropriate version given the contents
    """
    try:
        return _w***_header(header, (1, 0))
    except ValueError:
        pass

    try:
        ret = _w***_header(header, (2, 0))
...
def _write_array_header(fp, d, version=None):
    ...
    if version is None:
        header = _w***_header_guess_version(header)
    else:
        header = _w***_header(header, version)
    fp.write(header)
