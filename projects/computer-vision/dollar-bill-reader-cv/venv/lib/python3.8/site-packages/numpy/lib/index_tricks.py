...
def _fill_diagonal_dispatcher(a, val, w***=None):
    return (a,)


@array_function_dispatch(_fill_diagonal_dispatcher)
def fill_diagonal(a, val, w***=False):
    ...
    w*** : bool
      ...
      diagonal "w***ped" after N columns. You can have this behavior
    ...
    The w*** option affects only tall matrices:
    ...
    if a.ndim == 2:
        ...
        step = a.shape[1] + 1
        # This is needed to don't have tall matrix have the diagonal w***.
        if not w***:
