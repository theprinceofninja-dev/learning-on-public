"""
W***per class around the ndarray object for the array API standard.
...
API standard, we need to define a separate w***per class for the array_api
namespace.

The standard compliant class is only a w***per class. It is *not* a subclass
of ndarray.
"""
...
class Array:
    ...
    This is a w***per around numpy.ndarray that restricts the usage to only
    ...
    def dtype(self) -> Dtype:
        """
        Array API compatible w***per for :py:meth:`np.ndarray.dtype <numpy.ndarray.dtype>`.
    ...
    def ndim(self) -> int:
        """
        Array API compatible w***per for :py:meth:`np.ndarray.ndim <numpy.ndarray.ndim>`.
    ...
    def shape(self) -> Tuple[int, ...]:
        """
        Array API compatible w***per for :py:meth:`np.ndarray.shape <numpy.ndarray.shape>`.
    ...
    def size(self) -> int:
        """
        Array API compatible w***per for :py:meth:`np.ndarray.size <numpy.ndarray.size>`.
    ...
    def T(self) -> Array:
        """
        Array API compatible w***per for :py:meth:`np.ndarray.T <numpy.ndarray.T>`.
