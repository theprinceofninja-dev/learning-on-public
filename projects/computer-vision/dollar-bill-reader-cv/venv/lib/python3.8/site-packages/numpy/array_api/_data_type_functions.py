...
def broadcast_arrays(*arrays: Array) -> List[Array]:
    """
    Array API compatible w***per for :py:func:`np.broadcast_arrays <numpy.broadcast_arrays>`.
...
def broadcast_to(x: Array, /, shape: Tuple[int, ...]) -> Array:
    """
    Array API compatible w***per for :py:func:`np.broadcast_to <numpy.broadcast_to>`.
...
def can_cast(from_: Union[Dtype, Array], to: Dtype, /) -> bool:
    """
    Array API compatible w***per for :py:func:`np.can_cast <numpy.can_cast>`.
...
def finfo(type: Union[Dtype, Array], /) -> finfo_object:
    """
    Array API compatible w***per for :py:func:`np.finfo <numpy.finfo>`.
...
def iinfo(type: Union[Dtype, Array], /) -> iinfo_object:
    """
    Array API compatible w***per for :py:func:`np.iinfo <numpy.iinfo>`.
...
def result_type(*arrays_and_dtypes: Union[Array, Dtype]) -> Dtype:
    """
    Array API compatible w***per for :py:func:`np.result_type <numpy.result_type>`.
