...
typedef int translate_given_descrs_func(int nin, int nout,
        PyArray_DTypeMeta *w***ped_dtypes[],
...
typedef int _ufunc_w***ping_loop_func(PyObject *ufunc_obj,
        PyArray_DTypeMeta *new_dtypes[], PyArray_DTypeMeta *w***ped_dtypes[],
        translate_given_descrs_func *translate_given_descrs,
        translate_loop_descrs_func *translate_loop_descrs);
#define PyUFunc_AddW***pingLoop \
    (*(_ufunc_w***ping_loop_func *)(__experimental_dtype_api_table[7]))

/*
 * Type of the C promoter function, which must be w***ped into a
...
typedef NPY_CASTING (resolve_descriptors_function)(
        /* "method" is currently opaque (necessary e.g. to w*** Python) */
        PyObject *method,
