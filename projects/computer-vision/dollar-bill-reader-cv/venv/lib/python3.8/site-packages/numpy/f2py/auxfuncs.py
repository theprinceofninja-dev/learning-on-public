...
__all__ = [
    ...
    'isfunction_w***', 'isint1', 'isint1array', 'isinteger', 'isintent_aux',
...
def isfunction_w***(rout):
    if isintent_c(rout):
        return 0
    return w***funcs and isfunction(rout) and (not isexternal(rout))
...
def getcallprotoargument(rout, cb_map={}):
    ...
    if l_and(isstringfunction, l_not(isfunction_w***))(rout):
