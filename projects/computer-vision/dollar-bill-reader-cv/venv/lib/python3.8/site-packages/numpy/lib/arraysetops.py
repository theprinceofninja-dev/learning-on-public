...
def ediff1d(ary, to_end=None, to_begin=None):
    ...
    result = ary.__array_w***__(result)
    if l_begin > 0:
...
def unique(ar, return_index=False, return_inverse=False,
    ...
    * the number of times each unique value comes up in the input array
    ...
    flattened subarrays are sorted in lexicog***hic order starting with the
    first element.
    ...
    .. versionchanged: NumPy 1.21
        ...
        lexicog***hical order is chosen - see np.sort for how the lexicog***hical
