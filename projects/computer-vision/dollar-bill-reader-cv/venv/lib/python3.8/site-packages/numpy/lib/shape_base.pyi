...
# The signatures of `__array_w***__` and `__array_prepare__` are the same;
# give them unique names for the sake of clarity
class _ArrayW***(Protocol):
    def __call__(
        self,
        array: NDArray[Any],
...
class _SupportsArrayW***(Protocol):
    @property
    def __array_w***__(self) -> _ArrayW***: ...
...
@overload
def get_array_w***(*args: _SupportsArrayW***) -> _ArrayW***: ...
@overload
def get_array_w***(*args: object) -> None | _ArrayW***: ...
