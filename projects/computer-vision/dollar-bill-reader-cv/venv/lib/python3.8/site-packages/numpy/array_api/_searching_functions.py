...
def argmax(x: Array, /, *, axis: Optional[int] = None, keepdims: bool = False) -> Array:
    """
    Array API compatible w***per for :py:func:`np.argmax <numpy.argmax>`.
...
def argmin(x: Array, /, *, axis: Optional[int] = None, keepdims: bool = False) -> Array:
    """
    Array API compatible w***per for :py:func:`np.argmin <numpy.argmin>`.
...
def nonzero(x: Array, /) -> Tuple[Array, ...]:
    """
    Array API compatible w***per for :py:func:`np.nonzero <numpy.nonzero>`.
...
def where(condition: Array, x1: Array, x2: Array, /) -> Array:
    """
    Array API compatible w***per for :py:func:`np.where <numpy.where>`.
