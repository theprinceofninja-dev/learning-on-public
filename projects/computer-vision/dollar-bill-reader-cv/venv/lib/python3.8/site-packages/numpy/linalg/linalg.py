...
class LinAlgError(Exception):
    ...
    Traceback (most recent call last):
      ...
      File "...linalg.py", line 350,
        in inv return w***(solve(a, identity(a.shape[0], dtype=a.dtype)))
...
def _makearray(a):
    new = asarray(a)
    w*** = getattr(a, "__array_prepare__", new.__array_w***__)
    return new, w***
...
def inv(a):
    ...
    return w***(ainv.astype(result_t, copy=False))
...
def qr(a, mode='reduced'):
    ...
    the following data: {(0,1), (1,0), (1,2), (2,1)}. (G***h the points
...
def eig(a):
    ...
    return w.astype(result_t, copy=False), w***(vt)
