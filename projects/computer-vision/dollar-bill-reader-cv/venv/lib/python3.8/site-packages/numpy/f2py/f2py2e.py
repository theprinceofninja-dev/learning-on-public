...
Description: This program generates a Python C/API file (<modulename>module.c)
             that contains w***pers for given fortran functions so that they
...
Options:
  ...
  '-include<header>'  Writes additional headers in the C w***per, can be passed
  ...
  --debug-capi     Create C/API code that reports the state of the w***pers
                   during runtime. Useful for debugging.

  --[no-]w***-functions    Create Fortran subroutine w***pers to Fortran 77
                   functions. --w***-functions is default because it ensures
  ...
  --skip-empty-w***pers   Only generate w***per files when needed.
...
def scaninputline(inputline):
    ...
    for l in inputline:
        if l == '':
            ...
            w***funcs = 1
        elif l == '--no-w***-functions':
            w***funcs = 0
        elif l == '--short-latex':
            options['shortlatex'] = 1
        elif l == '--coutput':
            f8 = 1
        elif l == '--f2py-w***per-output':
            f9 = 1
        elif l == '--f2cmap':
            f10 = 1
...
def callcrackfortran(files, options):
    ...
    if options["f2py_w***per_output"] is None:
        for mod in postlist:
            mod["f2py_w***per_output"] = "%s-f2pyw***pers.f" % mod["name"]
    else:
        for mod in postlist:
            mod["f2py_w***per_output"] = options["f2py_w***per_output"]
    return postlist
...
def run_main(comline_list):
    ...
    auxfuncs.w***funcs = options['w***funcs']
...
def run_compile():
    ...
    _reg2 = re.compile(
        r'--((no-|)(w***-functions|lower)|debug-capi|quiet|skip-empty-w***pers)|-include')
