...
class Gnu95FCompiler(GnuFCompiler):
    ...
    def _link_w***per_lib(self, objects, output_dir, extra_dll_dir,
                          chained_dlls, is_archive):
        """Create a w***per shared library for the given objects
    ...
    def w***_unlinkable_objects(self, objects, output_dir, extra_dll_dir):
        """
