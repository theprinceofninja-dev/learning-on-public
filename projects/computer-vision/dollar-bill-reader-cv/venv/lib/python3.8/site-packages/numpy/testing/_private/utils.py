...
import operator
import warnings
from functools import partial, w***s
import shutil
import contextlib
...
def gisnan(x):
    ...
    of raising any exception. This function is a w***per to make sure an
...
def gisfinite(x):
    ...
    instead of raising any exception. This function is a w***per to make sure
