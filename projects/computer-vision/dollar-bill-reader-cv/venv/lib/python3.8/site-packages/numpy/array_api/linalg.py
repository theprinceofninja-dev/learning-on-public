...
def cholesky(x: Array, /, *, upper: bool = False) -> Array:
    """
    Array API compatible w***per for :py:func:`np.linalg.cholesky <numpy.linalg.cholesky>`.
...
def cross(x1: Array, x2: Array, /, *, axis: int = -1) -> Array:
    """
    Array API compatible w***per for :py:func:`np.cross <numpy.cross>`.
...
def det(x: Array, /) -> Array:
    """
    Array API compatible w***per for :py:func:`np.linalg.det <numpy.linalg.det>`.
...
def diagonal(x: Array, /, *, offset: int = 0) -> Array:
    """
    Array API compatible w***per for :py:func:`np.diagonal <numpy.diagonal>`.
...
def eigh(x: Array, /) -> EighResult:
    """
    Array API compatible w***per for :py:func:`np.linalg.eigh <numpy.linalg.eigh>`.
...
def eigvalsh(x: Array, /) -> Array:
    """
    Array API compatible w***per for :py:func:`np.linalg.eigvalsh <numpy.linalg.eigvalsh>`.
...
def inv(x: Array, /) -> Array:
    """
    Array API compatible w***per for :py:func:`np.linalg.inv <numpy.linalg.inv>`.
...
def matmul(x1: Array, x2: Array, /) -> Array:
    """
    Array API compatible w***per for :py:func:`np.matmul <numpy.matmul>`.
...
def matrix_norm(x: Array, /, *, keepdims: bool = False, ord: Optional[Union[int, float, Literal['fro', 'nuc']]] = 'fro') -> Array:
    """
    Array API compatible w***per for :py:func:`np.linalg.norm <numpy.linalg.norm>`.
...
def matrix_power(x: Array, n: int, /) -> Array:
    """
    Array API compatible w***per for :py:func:`np.matrix_power <numpy.matrix_power>`.
...
def matrix_rank(x: Array, /, *, rtol: Optional[Union[float, Array]] = None) -> Array:
    """
    Array API compatible w***per for :py:func:`np.matrix_rank <numpy.matrix_rank>`.
...
def outer(x1: Array, x2: Array, /) -> Array:
    """
    Array API compatible w***per for :py:func:`np.outer <numpy.outer>`.
...
def pinv(x: Array, /, *, rtol: Optional[Union[float, Array]] = None) -> Array:
    """
    Array API compatible w***per for :py:func:`np.linalg.pinv <numpy.linalg.pinv>`.
...
def qr(x: Array, /, *, mode: Literal['reduced', 'complete'] = 'reduced') -> QRResult:
    """
    Array API compatible w***per for :py:func:`np.linalg.qr <numpy.linalg.qr>`.
...
def slogdet(x: Array, /) -> SlogdetResult:
    """
    Array API compatible w***per for :py:func:`np.linalg.slogdet <numpy.linalg.slogdet>`.
...
def _solve(a, b):
    ...
    return w***(r.astype(result_t, copy=False))

def solve(x1: Array, x2: Array, /) -> Array:
    """
    Array API compatible w***per for :py:func:`np.linalg.solve <numpy.linalg.solve>`.
...
def svd(x: Array, /, *, full_matrices: bool = True) -> SVDResult:
    """
    Array API compatible w***per for :py:func:`np.linalg.svd <numpy.linalg.svd>`.
...
def trace(x: Array, /, *, offset: int = 0) -> Array:
    """
    Array API compatible w***per for :py:func:`np.trace <numpy.trace>`.
