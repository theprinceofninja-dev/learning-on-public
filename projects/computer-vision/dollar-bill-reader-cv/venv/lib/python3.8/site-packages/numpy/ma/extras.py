...
class _fromnxfunction:
    """
    Defines a w***per to adapt NumPy functions to masked arrays.


    An instance of `_fromnxfunction` can be called with the same parameters
    as the w***ped NumPy function. The docstring of `newfunc` is adapted from
    the w***ped function as well, see `getdoc`.
