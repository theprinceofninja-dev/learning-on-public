...
class flame_info(system_info):
    ...
    This requires libflame to be compiled with lapack w***pers:
    ...
    def check_embedded_lapack(self, info):
        """ libflame does not necessarily have a w***per for fortran LAPACK, we need to check """
        c = customized_ccompiler()
