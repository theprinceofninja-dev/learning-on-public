...
This is a proof-of-concept namespace that w***s the corresponding NumPy
...
serves mostly as a thin w***per around it. However, NumPy also implements a
...
w***ped in a w***per Array() class, but is otherwise unchanged. This submodule
...
- There is a custom array object, numpy.array_api.Array, which is returned by
  ...
  object is a small w***per class around numpy.ndarray. The main purpose of it
