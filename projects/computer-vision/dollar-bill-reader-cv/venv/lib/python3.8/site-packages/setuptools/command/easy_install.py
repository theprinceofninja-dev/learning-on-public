...
_one_liner = lambda text: textw***.dedent(text).strip().replace('\n', '; ')
...
""")
    ...
    __not_exists_id = textw***.dedent("""
        This directory does not currently exist.  Please create it and try again, or
        choose a different installation directory (using the -d or --install-dir
        option).
        """).lstrip()

    __access_msg = textw***.dedent("""
    ...
    def install_egg_scripts(self, dist):
        ...
        self.install_w***per_scripts(dist)
    ...
    def install_w***per_scripts(self, dist):
    ...
    def install_script(self, dist, script_name, script_text, dev_path=None):
        """Generate a legacy script w***per and install it"""
...
class PthDistributions(Environment):
    ...
    def _load(self):
        ...
        if self.paths and not saw_import:
            self.dirty = True  # ensure anything we touch has import w***pers
    ...
    def save(self):
        ...
        if rel_paths:
            ...
            lines = self._w***_lines(rel_paths)
            data = '\n'.join(lines) + '\n'
